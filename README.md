...
- Tu bitácora no se comparte con otra persona salvo cocreación explícita en el mismo repositorio. Bitácora no envía mensajes, no publica, no compra ni hace gastos en tu nombre.
...
- Los materiales de [`pruebas/`](pruebas/) son ejemplos ficticios: sirven para verificar el protocolo y no son recuerdos reales ni evidencia de mercado.
...
Bitácora es un punto de partida abierto para explorar mejores conversaciones sobre emprendimiento. Si vas a cambiar el protocolo, leé primero [`AGENTS.md`](AGENTS.md), conservá la distinción entre evidencia e hipótesis y no conviertas una sugerencia en una promesa de resultado.
